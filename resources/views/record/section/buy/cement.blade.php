<hr class="col-xs-12">
<div id="cement-buy-create-record">
  <form data-url="{{ url('records/create/buy-cement') }}" id="cement-buy-record-form">
    @csrf
    <div class="row">
      <div class="col-sm-4">
    ...
    <div class="row">
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input type="submit" id="save-cement-buy-record" class="btn btn-primary entry-submit-button" value="Save" />
        </div>
      </div>
      <div class="col-sm-6 invisible" id="cement-buy-record-success">
